<template>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="update_button">Измененние пользователя</h5>
    ...
    <script>
    import UIUpdateUserModal from './UIUpdateUserModal.vue'
    import { Field, Form, ErrorMessage } from 'vee-validate';
export default {
  components: { UIUpdateUserModal, Field, Form, ErrorMessage },
        name : "ui-update-user-modal",
        data() {
          return {
            userName: '',
            firstName: '',
      ...
      confirmPassword(value) {
        ...
        return true;
          ...
          getNewUserData() {
            const useru = {userName: this.userName,
