<template>
    <div class="modal fade" id="update_button" tabindex="-1" aria-labelledby="update_button" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="update_button">Измененние опроса</h5>
    ...
    <script>
    import UIUpdateSurveyModal from './UIUpdateSurveyModal.vue'
    import { Field, Form, ErrorMessage } from 'vee-validate';
export default {
  components: { UIUpdateSurveyModal, Field, Form, ErrorMessage },
        name : "ui-update-survey-modal",
        data() {
          return {
            beginDate: null,
            endDate: null,
      ...
      validateDescription(value) {
        ...
        return true;
          ...
          getNewSurveyData() {
            const surveyu = {beginDate: this.beginDate,
                            endDate: this.endDate,
                            title: this.title,
                            description: this.description}
    
            this.$emit("onSurveyUpdated", surveyu)
          }, 
    
        },
    
        emmits: ["onSurveyUpdated"]
    }
    </script>
